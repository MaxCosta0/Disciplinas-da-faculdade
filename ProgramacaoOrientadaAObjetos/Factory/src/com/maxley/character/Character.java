...
import com.maxley.decorator.AttackDecorator;
...
public abstract class Character implements Observable {
    ...
    public void toAttack() {        //trigged when <<Space Bar>> pressed
        ...
        for (int i = 0; i < this.observers.size(); i++) {
            ...
            if ((enemy.getPositionX() - this.positionX <= 1) && (enemy.getPositionY() - this.positionY <= 1)) {

                int enemyNewLifePoints = enemy.getLifePoints() - this.attack.getAttackDamage();
    ...
    public void decorateAttack(AttackDecorator attackDecorator) {
        this.attack = attackDecorator;
        System.out.println("Novo dano de ataque: " + this.attack.getAttackDamage());
    }
